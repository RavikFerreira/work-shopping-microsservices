...
@Singleton
@Produces
public class handlerShoppingResourceNotFoundException implements ExceptionHandler<ShoppingResourceNotFoundException, HttpResponse<StandardError>> {
    @Override
    public HttpResponse<StandardError> handle(HttpRequest request, ShoppingResourceNotFoundException ex) {
