...
@Singleton
@Produces
public class handlerProductResourceNotFoundException implements ExceptionHandler<ProductResourceNotFoundException, HttpResponse<StandardError>> {

    @Override
    public HttpResponse<StandardError> handle(HttpRequest request, ProductResourceNotFoundException ex) {
