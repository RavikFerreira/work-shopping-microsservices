...
@Singleton
@Produces
public class handlerItIsNotPossibleToAddAProductToTheMenuWithTheSameId implements ExceptionHandler<ItIsNotPossibleToAddAProductToTheMenuWithTheSameId, HttpResponse<StandardError>> {

    @Override
    public HttpResponse<StandardError> handle(HttpRequest request, ItIsNotPossibleToAddAProductToTheMenuWithTheSameId ex) {
